...
/**
 * Thrown when a negative discount rate is provided.
 * @author Brian Faust <brian@cline.sh>
 */
final class NegativeDiscountRateException extends InvalidArgumentException implements MoneyException
{
    /**
    ...
    {
        return new self(sprintf('Discount rate must not be negative, got %s.', $rate));
    }
}
