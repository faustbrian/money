...
final readonly class RationalMoney extends AbstractMoney implements Stringable
{
     ...
     *
     * @return self A new RationalMoney for the given amount and currency.
     */
     ...
     *
     * @return self A new RationalMoney with a zero amount in the given currency.
     */
     ...
     * @return self                   A new RationalMoney representing the sum.
     */
     ...
     * @throws MathException          If the argument is not a valid number.
     * @throws MoneyMismatchException If the argument is a money in another currency.
     * @return self                   A new RationalMoney representing the difference.
     */
     ...
     *
     * @throws MathException If the argument is not a valid number.
     * @return self          A new RationalMoney representing the product.
     */
     ...
     *
     * @throws MathException If the argument is not a valid number.
     * @return self          A new RationalMoney representing the quotient.
     */
    ...
    /**
     * Returns a copy of this RationalMoney with the amount simplified.
     *
     * @return self A new RationalMoney whose amount fraction is in lowest terms.
     */
